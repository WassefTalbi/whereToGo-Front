...
import {
  fetchattachmentData, fetchbookmarkData, fetchcallsData,
  fetchchannnelData,
  fetchchatData,
  fetchcontactData,
  fetchmessagesData
...
import {
  selectattachmentData, selectbookmarkData, selectcallData,
  selectcallslistData,
  selectchannelData,
  selectcontactData,
  selectData
...
@Component({
  ...
  standalone: true,
    imports: [CommonModule, BsDropdownModule, PickerComponent, ReactiveFormsModule, SimplebarAngularModule, TooltipModule, UiSwitchModule],
